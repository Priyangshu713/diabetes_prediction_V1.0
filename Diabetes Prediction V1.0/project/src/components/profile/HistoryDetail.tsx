...
export default function HistoryDetail({ record }: HistoryDetailProps) {
  ...
  return (
    <div className="space-y-4 animate-fadeIn">
      {/* Summary Card */}
      <div className={`rounded-2xl bg-gradient-to-b ${getRiskColor(record.risk)} p-4 border border-white/5`}>
        ...
        <div className="mt-2 text-2xl font-bold text-white">
          {(record.risk * 100).toFixed(0)}% Risk Level
        </div>
        <div className="mt-4 grid grid-cols-2 gap-3">
          ...
          <div className="bg-gray-900/30 rounded-xl p-3">
            ...
            <div className="text-lg font-medium text-white">{record.weight} <span className="text-sm">kg</span></div>
          </div>
          <div className="bg-gray-900/30 rounded-xl p-3">
